...
class UntitledTestCaseAdmin(unittest.TestCase):
    def setUp(self):
    ...
    def test_untitled_test_case_admin(self):
        driver = self.driver
        ...
        driver.find_element(By.LINK_TEXT,"Corporate Branding").click()
        driver.get("https://opensource-demo.orangehrmlive.com/web/index.php/admin/addTheme")
        driver.find_element(By.XPATH,"//div[@id='app']/div/div/header/div[2]/nav/ul/li[7]/span").click()
        driver.find_element(By.XPATH,"//div[@id='app']/div/div/header/div[2]/nav/ul/li[7]/span").click()
